...
`v0.5.11` · `Paper/Velocity 1.20+` · `Java 21` · `MySQL 8`
...
| 服务器 | 安装文件 | 说明 |
|--------|----------|------|
| **Paper/Folia 子服** | `dreamport-plugin-0.1.0.jar` | 进服拦截、聊天互通、经济采集 |
| **Velocity 代理**（可选） | `dreamport-plugin-proxy-0.1.0.jar` | 代理端统一拦截（用了代理则子服插件设 `role: secondary`） |
...
# 产物:
#   dreamport-server/target/dreamport-server-0.1.0.jar
#   dreamport-plugin/target/dreamport-plugin-0.1.0.jar
#   dreamport-plugin-proxy/target/dreamport-plugin-proxy-0.1.0.jar
```
