...
| [皮肤站插件](admin/plugin-skinstation/introduction.md) | BlessingSkin(PHP) | PHP(Laravel) | 用 DreamPort 账号登录皮肤站、账号开通与双向同步 |
...
| [皮肤站](player/skin-station.md) | 皮肤站账号开通、登录、皮肤管理、启动器配置 |
...
| 皮肤站 dreamport-oauth | [简介与架构](admin/plugin-skinstation/introduction.md) · [安装与配置](admin/plugin-skinstation/installation-and-config.md) · [对接 DreamPort](admin/plugin-skinstation/dreamport-integration.md) · [账号同步](admin/plugin-skinstation/account-sync.md) · [接口文档](admin/plugin-skinstation/api-reference.md) · [更新日志](admin/plugin-skinstation/changelog.md) |
...
- [docs/BLESSINGSKIN.md](../docs/BLESSINGSKIN.md) — 皮肤站互通部署指南

## 许可与来源

- 全部代码原创实现(MIT),禁止引入第三方 GPL 代码(见仓库 [Rules.md](../Rules.md))
- 皮肤站插件要求 BlessingSkin ≥ 5.0.0(已在 6.0.2 实测);BlessingSkin 本体遵循其自身许可
