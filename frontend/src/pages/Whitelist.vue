      ...
      <div class="card p-6 mb-6 text-left">
        ...
        <div class="mb-5 text-center">
          <a @click.prevent="goToDocs" href="#"
            class="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-orange-500/15 border border-orange-500/30 text-orange-400 hover:bg-orange-500/25 transition-colors duration-200 group cursor-pointer">
...
">
        ...
        <div class="grid grid-cols-1 gap-4">
          <!-- 方式1：服内玩家邀请 -->
          <button @click="showInviteModal = true" class="p-6 rounded-xl bg-gradient-to-br from-blue-500/10 to-cyan-500/10 border border-blue-500/30 hover:border-blue-500/50 transition-colors text-left group">
          ...
          <!-- 方式2：问卷入服申请 -->
          <button @click="goToQuestionnaire" class="p-6 rounded-xl bg-gradient-to-br from-orange-500/10 to-amber-500/10 border border-orange-500/30 hover:border-orange-500/50 transition-colors text-left group">
            <div class="flex items-center gap-4">
